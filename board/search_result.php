...
<div class="container-fluid">
  ...
  <div class="input-group mb-3" style="width: 100%;">
    ...
    <input type="search" name='search' class="form-control" style="width: 85%;" placeholder="Search..." aria-label="Search" onkeyup="checkSpecialChar(this)">
  </div>
</form>
...
if(isset($_POST['category']) && isset($_POST['search'])){
  ...
  $stmt = $conn->prepare("SELECT * FROM article WHERE $column = ? ORDER BY idx DESC");
